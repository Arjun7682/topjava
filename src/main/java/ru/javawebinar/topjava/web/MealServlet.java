    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action == null ? "all" : action) {
            case "delete":
                ...
                log.info("Delete {}", id);
                repository.delete(id, profileRestController.get().getId());
                response.sendRedirect("meals");
                break;
            case "create":
            case "update":
                final Meal meal = "create".equals(action) ?
                        ...
                        repository.get(getId(request), profileRestController.get().getId());
            ...
            default:
                ...
                request.setAttribute("meals",
                        MealsUtil.getWithExcess(repository.getAll(profileRestController.get().getId()), MealsUtil.DEFAULT_CALORIES_PER_DAY));
